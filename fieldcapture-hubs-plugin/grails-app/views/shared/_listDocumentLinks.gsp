<div class="clearfix" data-bind="visible:transients.mobileApps().length > 0" style="margin:4px 0">
...
<div class="clearfix" data-bind="visible:transients.socialMedia().length > 0" style="margin:4px 0">
